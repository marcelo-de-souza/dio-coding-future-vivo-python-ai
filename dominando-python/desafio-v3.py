...
class Conta_Corrente(Conta):
    ...
    def sacar(self, valor):
        ...
        if excedeu_limite:
            print("Operação não realizada! O valor do saque foi excedido.")
...
def depositar(clientes):
    cpf = input("Informeo CPF do cliente: ")
    ...
    cliente.realizar_trasacao(conta, trasacao)
...
def criar_cliente(clientes):
    ...
    data_de_nascimento = input("Informe a data de nascimento (dd-mm-aaa): ")
...
def criar_conta(numero_conta, clientes, contas):
    ...
    if not cliente:
        print("Cliente não encontrado! Processo de criação de conta encerrado.")
        return
